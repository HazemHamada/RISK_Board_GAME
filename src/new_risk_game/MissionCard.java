...
public final class MissionCard {
    ...
    private boolean mission1,mission2,mission3,mission4,mission5,mission6,mission7,mission8,mission9,mission10,mission11,mission12/*,mission13,mission14*/;
    ...
    public MissionCard(Player p){
        ...
        int j=0;
        while(j<a.size()){
            while(i==(int)a.get(j))//34an 2l mission mttkrrar4
                i=randomMission();
            j++;
        }
        player=p;
